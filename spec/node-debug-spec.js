...
import NodeDebug from '../lib/node-debug';
  ...
  describe('when the node-debug:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let nodeDebugElement = workspaceElement.querySelector('.node-debug');
        expect(nodeDebugElement).toExist();

        let nodeDebugPanel = atom.workspace.panelForItem(nodeDebugElement);
